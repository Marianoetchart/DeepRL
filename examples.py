...
def dqn_pixel_atari(name):
    ...
    config.network_fn = lambda: AttentionNet(config.action_dim, TempAttDRQNBody(in_channels=config.history_length))
    ...
    config.tag = 'TempAtt-Pong-Flickering'#'DRQN-4SGDCorrHidd-50kexp'
